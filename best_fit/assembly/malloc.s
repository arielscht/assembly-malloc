    ...
    jge end_alloc_while                 # Exits the loop
        ...
        jne end_occupied_if             # Jumps to end_if
            ...
            jl end_occupied_if          # Jumps to end_if
                cmpq $0, %r9            # Check if smallest is NULL
                jne size_else           # Jumps to else
                    movq %r13, %r10     # smallest_size := block_size
                    movq %rbx,  %r9     # smallest := addr
                    jmp end_occupied_if
size_else:
                cmpq %r10, %r13         # Compares smallest_size with block_size
                jge end_occupied_if     # Jumps to end_if
                    movq %r13, %r10     # smallest_size := block_size
                    movq %rbx,  %r9     # smallest := addr
end_occupied_if:
